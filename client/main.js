	...
	var step = [
		{
			...
			desc: "\
				...
				<p>This video isn't about getting a zillion frames per second in Crysis 6 while running on 3 8k TVs and surround. This video isn't about liquid cooling your CPU, your graphics card and that cheeky smirk off your buddy's face all at once. It's about getting good value and upgradability out of your new gaming PC without spending a whole lot of money.</p>\
		...
		},
		{
			...
			ts: 120,
			desc: "\
				<p>Our CPU choice was all about compromises: it gives up multiple processing cores, it gives up hyper threading and it gives up turbo boost. It also gives up the massive cache that the higher end has well and has only processors in its family enjoy.</p>\
				<p>But dern it, this chip has spunk. And with a little overclocking it'll hold up surprisingly well in all but the most demanding triple-a titles even when fighting well above its weight class.	As we demonstrated in this little video, a couple of weeks ago you can easily swap it out for a core i3 or a core i5. If you want a little bit more horsepower though without changing anything else in this build guide.</p>\
				<p>Hold your CPU by the edges and identify the corner with the gold triangle, align that with the corner of the socket that has a triangle as well lift up the retention arm lift up the socket cover place the CPU into the socket with no force lower the cover and fasten the retention arm again.</p>\
				"
		},
		{
			name: 'Cooling',
			ts: 184,
			desc: "\
			<p>Fancy coolers are the kind of thing that rich kids with their H2Os and LN2s might get to enjoy. But if your dad is a blue-collar honest working man kind of guy, well you might just find that stock cooling does a good enough job for a mild overclock and doesn't cost you a penny, unless you grab a can of stove paint for 6 bucks and make it look badass that is.	Besides, you can always game on it now and splurge you know 30 bucks on a cooler next time you've got some walking-around money.</p>\
		...
		},
		{
			...
			ts: 249,
			desc: "\
			<p>Buying RAM is easy for a value gaming build, don't get fussed about which kit we're using.	Just go to your favorite store or shopping website, find the least expensive dual channel DDR3 kit in the capacity of your choice from a reputable brand like Kingston, Corsair, G.Skill or Adata and buy it. XMP support is a bonus, but the speed of the RAM doesn't matter too much.</p>\
			<p>Pull back the tabs on the 2 grey RAM slots, then position each dim so the notch in the socket and press firmly on both ends until the tabs at the ends snap back into place on their own.</p>\
			"
		},
		{
			name: 'Case',
			...
			desc: "\
				...
				<p>And sometimes I'm just morbidly curious. So today we'll be building in the SPEC-01 because I just wanted to know if this $50 gaming case can deliver an experience that still lives up to the Corsair name.</p>\
				<p>Pull the side panels off and stash the thumb screws somewhere safe along with the rest of the included hardware.</p>\
				<p>The case's only included 120 millimeter cooling fan is already installed in the front, which is a good place for it since that intake is filtered to keep the PCs guts both clean and cool. If we had beefier hardware, a rear or top exhaust fan though would be a good addition.</p>\
			"
		},
		{
			name: 'Motherboard',
			...
			<p>So we went with a Z97-C from ASUS because it has official support for overclocking, although lower end boards even business grade ones are known to do it. And it's got a good balance of features - quality and expandability to price.</p>\
			<p>Press firmly on the four corners of the I/O shield until they snap into place, then plug the eight pin power supply connector in. Now, to avoid a cable management nightmare later on: place the board down on the integrated standoffs and install the screws that look like this into the five positions around the perimeter of the board. The middle one can be left blank; this is just a post to hold the board in place while you secure it.</p>\
			<p>While you have easy access to the board, plug in the front power and reset switches as well as the power and drive activity LEDs. Follow up with the block style connectors for USB to front audio and USB-3, then finally plug your front fan into the header on the motherboard here so we can use software to control it later.</p>\
			"
		},
		{
			name: 'PSU',
			ts: 419,
			desc: "\
			<p>To practical folks there's only really a couple things to consider when shopping for a budget power supply: price and quality. Me, I can be a bit of a sucker for looks, so when I saw that the 430 watt CXN is on with a $20 rebate for only 40 bucks, I went for it.</p>\
			<p>It's black, semi modular and 80 plus bronze making it a solid deal compared to the C Sonic gray unit that I normally use for budget builds. For another 15 bucks to 600 watt version though would be good if you want a bit more growing room, but other than a quad core or a slightly better graphics card, this system isn't really being built to be super upgradable. So the 430 watt is a great choice.</p>\
			<p>Slide the power supply in grille side up for better cooling and attach it to the case using four of these screws. You already ran the eight pin connector when we cheated a bit in the last step, so plug in the 24 pin connector being cognizant of the space you'll need behind the motherboard tray for cable management when you try to close the rear panel.<p>\
			<p>Plug in a modular SATA cable and run that over to the front bays. Then plug in a PCI Express connector and run that to this cable management hole right here.</p>\
			"
		},
		{
			name: 'SSD',
		...
		},
		{
			...
			ts: 547,
			desc: "\
			<p>Choosing the best graphics card for a value gaming rig can be done one of two ways:</p>\
			<p>Method number one - find a recent video card roundup, find the lowest price you can for each of the cards in it, then divide the frame rates the reviewer gets in the games you want to play by the price. And by whichever one delivers the best FPS per dollar.</p>\
		...
		},
		{
			...
			<p>The good news though is that the rear side panel bulges out, so installing it over top of our slightly rat's-nest-y wire arrangement here is actually no big deal.</p>\
			"
		},
		{
			name: 'Peripherals',
		...
		},
		{
			...
			<p>Hit F7 to get into advanced mode, and turn your CPU multiplier up to something in the 42 - 44 range. You shouldn't need to touch any other settings, but while you're in here you might as well check and make sure your RAM is running at its rated speed. Enable XMP, if that option is available.</p>\
			<p>To install your Windows operating system, create a bootable USB drive, and then reboot while mashing F8 immediately to get into the boot device selection menu where you'll pick your USB drive.</p>\
			<p>Once the setup process has begun. It's basically a matter of clicking next until you land on the Windows desktop. Once you're booted, drivers can be found on the manufacturer websites for ASUS, Intel, etcetera. And this is a good time to hit up <a href='https://ninite.com/'>ninite.com</a> to pick up your favorite free applications and a nice easy to use junkware free package.</p>\
			"
		},
		{
			name: 'Results',
